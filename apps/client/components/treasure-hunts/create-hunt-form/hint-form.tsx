...
export const HintForm: React.FC<HintFormProps> = ({
  ...
  return (
    <Card
      className={`transition-all duration-200 ${isExpanded ? "shadow-md" : "shadow-sm"}`}
    >
      <View className="flex-row justify-between items-center">
        ...
        >
          <Text
            className={`flex-1 text-lg font-semibold text-gray-900 dark:text-white ${!isExpanded ? "text-base" : ""}`}
          >
